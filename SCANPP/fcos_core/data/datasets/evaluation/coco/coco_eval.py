...
def log_ap50_per_class(coco_eval, iou_type):
    ...
    # T = 10 (IoU thresholds), R = 101 (Recall thresholds), K = num_classes
    ...
    iou_thr_index = 0  # AP50 is at index 0 (IoU = 0.50)
    precision_ap50 = precision[iou_thr_index, :, :, 0, -1]  # [R, K]

    # mean across recall thresholds
    ap50_per_class = np.mean(precision_ap50, axis=0)  # shape: [K]
