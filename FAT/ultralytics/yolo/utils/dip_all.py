...
from ultralytics.yolo.utils.defog_train_config import cfg
    ...
    def forward(self, img_input, defog_A, IcA):
        ...
        for j, filter in enumerate(filters):
            ...
            self.filtered_image_batch, filter_parameter = filter.apply(
                self.filtered_image_batch, self.Pr, self.defog_A, self.IcA)
            # self.filtered_image_batch, filter_parameter = filter.apply(
