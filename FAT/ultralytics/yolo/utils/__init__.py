...
DEFAULT_CFG_PATH_t = ROOT / 'yolo/cfg/default_teacher.yaml'
...
DEFAULT_CFG_DICT_t = yaml_load(DEFAULT_CFG_PATH_t)
for k, v in DEFAULT_CFG_DICT_t.items():
    if isinstance(v, str) and v.lower() == 'none':
        DEFAULT_CFG_DICT_t[k] = None
DEFAULT_CFG_KEYS_t = DEFAULT_CFG_DICT_t.keys()
DEFAULT_CFG_t = IterableSimpleNamespace(**DEFAULT_CFG_DICT_t)
