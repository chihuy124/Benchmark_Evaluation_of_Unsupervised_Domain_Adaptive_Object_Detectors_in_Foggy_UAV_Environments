...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str, default='/home/lenovo/data/liujiaji/yolov8/ultralytics-main-8.2.50/runs/train/v5/v2c/weights/best.pt', help='trained weights path')
