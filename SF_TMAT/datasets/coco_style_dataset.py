...
class CocoStyleDataset(CocoDetection):
    ...
    img_dirs = {
        'cityscapes': {
            'train': '/run/media/test/desk2/baoshuai/MRT-release-main/data/train/images', 'val': '/run/media/test/desk2/baoshuai/MRT-release-main/data/val/images'
        },
        'foggy_cityscapes': {
            'train': '/run/media/test/desk2/baoshuai/MRT-release-main/data/train/hazy_images', 'val': '/run/media/test/desk2/baoshuai/MRT-release-main/data/val/hazy_images',
            "test":'G:\Haze\RDDTS\images'
        },
        'bdd100k': {
        ...
        'uitdrone': {
            'train': '/data2/uittogether/LuuTru/huytnc/dataset/uit_drone/images/source_train/',
            'val': '/data2/uittogether/LuuTru/huytnc/dataset/uit_drone/images/source_test/'
        },
        'foggy_uitdrone': {
            'train': '/data2/uittogether/LuuTru/huytnc/dataset/uit_drone/images/target_train/',
            'val': '/data2/uittogether/LuuTru/huytnc/dataset/uit_drone/images/target_test/',
            "test": '/data2/uittogether/LuuTru/huytnc/dataset/uit_drone/images/target_test/'
        },
    }
    anno_files = {
        'cityscapes': {
            'source': {
                'train': '/run/media/test/desk2/baoshuai/MRT-release-main/data/train/train_coco.json',
                'val': '/run/media/test/desk2/baoshuai/MRT-release-main/data/val/val_coco.json',
            },
            'target': {
        ...
        'uitdrone': {
            'source': {
                'train': '/data2/uittogether/LuuTru/huytnc/dataset/uit_drone/train.json',
                'val': '/data2/uittogether/LuuTru/huytnc/dataset/uit_drone/test.json',
            }
        },
        'foggy_uitdrone': {
            'target': {
                'train': '/data2/uittogether/LuuTru/huytnc/dataset/uit_drone/train.json',
                'val': '/data2/uittogether/LuuTru/huytnc/dataset/uit_drone/test.json',
                "test":'/data2/uittogether/LuuTru/huytnc/dataset/uit_drone/test.json'
            }
        },
    }
