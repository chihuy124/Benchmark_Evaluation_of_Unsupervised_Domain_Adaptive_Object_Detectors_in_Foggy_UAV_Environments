...
def build_city_DA(image_set, args,strong_aug):
    ...
    PATHS_Source = {
        "train": ("/data2/uittogether/LuuTru/huytnc/dataset/uit_drone/images/source_train/",
                  "/data2/uittogether/LuuTru/huytnc/dataset/uit_drone/train.json"),
        "val": ("/data2/uittogether/LuuTru/huytnc/dataset/uit_drone/images/source_test/",
                "/data2/uittogether/LuuTru/huytnc/dataset/uit_drone/test.json"),
    }
    #----目标域
    PATHS_Target = {
    ...
    if image_set == 'train': #双域训练
        ...
        dataset_S = CocoDetection(img_folder_S, ann_file_S,
                transforms=make_coco_transforms(image_set, fix_size=args.fix_size, strong_aug=False, args=args), #不使用自带的强增强
...
def build_hazy_DA(image_set, args,strong_aug):

    #---源域
    PATHS_Source = {
        "train": ("/data2/uittogether/LuuTru/huytnc/dataset/HazyDet/train/images/",
                  "/data2/uittogether/LuuTru/huytnc/dataset/HazyDet/train.json"),
        "val": ("/data2/uittogether/LuuTru/huytnc/dataset/HazyDet/test/images/",
                "/data2/uittogether/LuuTru/huytnc/dataset/HazyDet/test.json"),
    }
    #----目标域
    PATHS_Target = {
        "train": ("/data2/uittogether/LuuTru/huytnc/dataset/HazyDet/train/hazy_images/",
                  "/data2/uittogether/LuuTru/huytnc/dataset/HazyDet/train.json"),
        "val": ("/data2/uittogether/LuuTru/huytnc/dataset/HazyDet/test/hazy_images/",
                "/data2/uittogether/LuuTru/huytnc/dataset/HazyDet/test.json"),
    }
