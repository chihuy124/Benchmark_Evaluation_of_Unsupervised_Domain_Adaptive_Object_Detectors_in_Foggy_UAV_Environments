...
#---遥感
from .DAcoco import build_city_DA,build_sim2city_DA,build_city2BDD_DA,build_hazy_DA
...
def build_dataset(image_set, args,strong_aug = False):
    ...
    if args.dataset_file == 'hazy':
        return build_hazy_DA(image_set, args,strong_aug)
