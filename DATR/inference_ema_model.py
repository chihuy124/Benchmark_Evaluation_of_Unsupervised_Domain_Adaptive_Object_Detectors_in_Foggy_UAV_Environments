...
def visualize_and_save(image, pred_dict, save_path):
    ...
    for box, label in zip(pred_dict['boxes'], pred_dict['box_label']):
        ...
        # 如果可用，绘制标签
        if font:
            draw.text((x1, y1-20), label_list[label-1], fill='red', font=font)
        else:
...
model_config_path = "/data2/uittogether/LuuTru/huytnc/DATR/config/DA/uitdrone2foggy/DINO_4scale_uitdrone2F_self_training.py" # change the path of the model config file
model_checkpoint_path = "/data2/uittogether/LuuTru/huytnc/DATR/logs/DINO_uitdrone2foggy_self_training/R50_ms4/best_ema_model.pth" # change the path of the model checkpoint
...
if __name__ == '__main__':
    img_dir = "/data2/uittogether/LuuTru/huytnc/dataset/uit_drone/images/target_test/"
    save_dir = "/data2/uittogether/LuuTru/huytnc/DATR/visualize/"


    label_list = ['motor','car','bus', 'pedestrian']
