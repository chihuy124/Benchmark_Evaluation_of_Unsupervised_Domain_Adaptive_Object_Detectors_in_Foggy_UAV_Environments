...
def add_hook(model):
    target_layer = model.backbone[0].body.layer1[0]  # Change this to the layer of interest
...
def main(args):
    ...
    print("model.backbone[0].body: ", model.backbone[0].body)
    ...
    if args.eval:
        ...
        img_path = "/data2/uittogether/LuuTru/huytnc/BiADT/fog_1.jpg"  # Specify the image path here
        ...
        if feature_maps:
            for idx, fm in enumerate(feature_maps):
                ...
                fig.savefig('/data2/uittogether/LuuTru/huytnc/DATR/feature_map.png')
        ...
        # ----2.加入伪标签,self-training训练
            ...
            if epoch == cfg.burn_epochs:
                ...
                checkpoint = torch.load(
                    "/data2/uittogether/LuuTru/huytnc/DATR/logs/DINO_uitdrone2foggy/R50_ms4/best_ema_teacher.pth",
                    map_location="cpu"
                )
