...
class DatasetCatalog(object):
    DATA_DIR = "/storageStudents/nguyenvd/Huytnc/dataset/" # dataset root
    ...
    DATASETS = {
        ...
        "uit_drone_train_cocostyle": {
            "img_dir": "uit_drone/images/source_train",
            "ann_file": "uit_drone/train.json"
        },
        "uit_drone_test_cocostyle": {
            "img_dir": "uit_drone/images/source_test",
            "ann_file": "uit_drone/test.json"
        },
        "uit_drone_foggy_train_cocostyle": {
            "img_dir": "uit_drone/images/target_train",
            "ann_file": "uit_drone/train.json"
        },
        "uit_drone_foggy_test_cocostyle": {
            "img_dir": "uit_drone/images/target_test",
            "ann_file": "uit_drone/test.json"
        },
        
        "hazydet_train_cocostyle": {
            "img_dir": "HazyDet/train/images/",
            "ann_file": "HazyDet/train.json"
        },
        "hazydet_test_cocostyle": {
            "img_dir": "HazyDet/test/images/",
            "ann_file": "HazyDet/test.json"
        },
        "hazydet_foggy_train_cocostyle": {
            "img_dir": "HazyDet/train/hazy_images/",
            "ann_file": "HazyDet/train.json"
        },
        "hazydet_foggy_test_cocostyle": {
            "img_dir": "HazyDet/test/hazy_images/",
            "ann_file": "HazyDet/test.json"
        },
        "rddts_train_cocostyle": {
            "img_dir": "RDDTS/train/",
            "ann_file": "RDDTS/train.json"
        },
        "rddts_test_cocostyle": {
            "img_dir": "RDDTS/test/",
            "ann_file": "RDDTS/test.json"
        },
