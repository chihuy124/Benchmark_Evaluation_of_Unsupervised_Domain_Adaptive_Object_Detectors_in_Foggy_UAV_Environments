    ...
    def forward(self, outputs, targets):
        ...
        with torch.no_grad():
            ...
            for b_idx in range(bs):
                ...
                cost = C[b_idx, :, tgt_offset : tgt_offset + num_tgt]  # [num_queries, num_tgt]
                tgt_offset += num_tgt
